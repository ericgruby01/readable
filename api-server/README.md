...
## Custom endpoints
The following endpoints were added to customize the API

| Endpoints       | Usage          | Params         |
|-----------------|----------------|----------------|
| `POST /posts/:id/publish` | Sets the deleted flag for a post to 'false'. <br> Sets the parentDeleted flag for all child comments to 'false'. | |
| `PUT /posts/:id/favorite` | Toggle favorite state | **id** - [String] Post id |
| `PUT /categories` | Add a new category. | **path** - [String] URL friendly path <br> **name** - [String] Category name |
| `PUT /comments/:id/publish` | Sets the deleted flag for a post to 'false'. | |