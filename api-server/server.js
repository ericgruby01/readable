...
app.post('/posts/:id/publish', (req, res) => {
    posts.publish(req.token, req.params.id)
      .then(post => comments.publishByParent(req.token, post))
      .then(
          (data) => res.send(data),
          (error) => {
              console.error(error)
...
app.put('/posts/:id/favorite', (req, res) => {
    posts.favoriteStatus(req.token, req.params.id)
      .then(
        (data) => res.send(data),
          (error) => {
              console.error(error)
...
app.put('/categories/', bodyParser.json(), (req, res) => {
    categories.addCategory(req.token, req.body)
        .then(
            (data) => res.send(data),
            (error) => {
                console.error(error)
...
app.put('/comments/:id/publish', (req, res) => {
    comments.enable(req.token, req.params.id)
      .then(
          (data) => res.send(data),
          (error) => {
              console.error(error)
